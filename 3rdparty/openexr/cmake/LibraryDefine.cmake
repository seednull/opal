...
function(OPENEXR_DEFINE_LIBRARY libname)
  ...
  set_target_properties(${libname} PROPERTIES
      ...
      RUNTIME_OUTPUT_DIRECTORY_RELEASE "${OPAL_DIR_EXPORT}/${OPAL_PLATFORM}/${OPAL_ABI}"
      RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL "${OPAL_DIR_EXPORT}/${OPAL_PLATFORM}/${OPAL_ABI}"
      RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${OPAL_DIR_EXPORT}/${OPAL_PLATFORM}/${OPAL_ABI}"
      RUNTIME_OUTPUT_DIRECTORY_DEBUG "${OPAL_DIR_EXPORT}/${OPAL_PLATFORM}/${OPAL_ABI}"
  )
