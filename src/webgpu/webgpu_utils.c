...
{
	static Opal_TextureFormat wgpu_formats[] =
	{
		OPAL_TEXTURE_FORMAT_UNDEFINED,
		...
		OPAL_TEXTURE_FORMAT_UNDEFINED, // TODO: add rgb10a2 uint support
		OPAL_TEXTURE_FORMAT_UNDEFINED, // TODO: add rgb10a2 unorm support
		...
		OPAL_TEXTURE_FORMAT_UNDEFINED, // TODO: add stencil8 support
		OPAL_TEXTURE_FORMAT_D16_UNORM,
		OPAL_TEXTURE_FORMAT_UNDEFINED, // TODO: add d24+ support
...
Opal_PresentMode webgpu_helperFromPresentMode(WGPUPresentMode mode)
{
	switch (mode)
	{
		case WGPUPresentMode_Fifo: return OPAL_PRESENT_MODE_FIFO;
		case WGPUPresentMode_Immediate: return OPAL_PRESENT_MODE_IMMEDIATE;
		case WGPUPresentMode_Mailbox: return OPAL_PRESENT_MODE_MAILBOX;
